//C - 39 não requer alteração do projeto, pois este se encontra completo. Achei incomum.
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distância: "+ distancia,camera.x + 400,30);
  
  if(estadoJogo===JOGAR){
    ciclistaPrincipal.velocityX = 5;
  ...
  text("Aperte a tecla direcional para cima para reiniciar o jogo!",fimdeJogo.x - 225,200)
